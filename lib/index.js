  ...
  var Template = (_temp = _class = function (_PureComponent) {
    ...
    _createClass(Template, [{
      ...
      value: function render() {
        ...
        return React.createElement('div', { className: className }, this.renderGroup());
      }
    }]);
        ...
        _createClass(_class, [{
          ...
          value: function render() {
            ...
            if (!name) {
              ...
              component = React__default.createElement(Component, _extends({}, others, { field: field, bus: bus, style: style }));
            } else {
              var getFieldDecorator = form.getFieldDecorator;

              var decorator = getFieldDecorator(name, cfg);
              // 调用 Form::getFieldDecorator API 使其支持校验等功能
              component = decorator(React__default.createElement(Component, _extends({}, others, { form: form, field: field, bus: bus })));
            }
